...
function http(path, config) {
    return __awaiter$2(this, void 0, void 0, function* () {
        ...
        console.log(request, '_localStorage.getItem("bloggrs::token")', _localStorage$1.getItem("bloggrs::token"), '-');
...
const posts = ({ serverUrl, BlogId }) => ({
    ...
    likePostHandler: ({ PostId, action }) => __awaiter$6(undefined, void 0, void 0, function* () {
