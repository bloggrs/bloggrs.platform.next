...
function http$1(path, config) {
    return __awaiter$2(this, void 0, void 0, function* () {
        ...
        if (!response.ok) {
            console.log('debug', path, response);
...
class Bloggrs {
    constructor(apiKey) {
        this.serverUrl = 'http://localhost:4000/api/v1' //'https://bloggrs-api-i1.herokuapp.com/api/v1';
        this.apiKey = null;
        this.BlogId = 1;
        this.blog = null;
        ...
        this._initialize = (apiKey) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!apiKey) {
                ...
                if (subdomain === "localhost")
                    subdomain = "b-blog-1";
                var blog_id = subdomain.replace("b-blog-", "")
                res = yield get(this.serverUrl + `/blogs/${blog_id}`);
            }
            else {
